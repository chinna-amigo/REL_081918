...
public class PanelController {
	...
	public ResponseEntity<?> hourlyElectricity(@PathVariable(value = "banel-serial") String panelSerial,
	...
	public ResponseEntity<List<DailyElectricity>> allDailyElectricityFromYesterday(
		...
		dailyElectricityForPanel = hourlyElectricityService.getAllDailyElectricityFromYesterday(panel.getId());
